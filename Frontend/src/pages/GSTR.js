      ...
      <section class="container">
        ...
        <table class="text-center">
            ...
            gstdata.map((party, i) => (
              <>
                  ...
                  {gstdata.items &&
                    gstdata.items.map(() => (
                      <>
                        ...
                        <td class="border border-black">6%</td>
                        <td class="border border-black">₹ 95.24</td>
                        <td class="border border-black">₹ 0</td>
                        <td class="border border-black">₹ 2.38</td>
                        <td class="border border-black">₹ 2.38</td>
                        <td class="border border-black">₹ 0</td>
                        <td class="border border-black">₹ 0</td>
                        <td rowspan="2" class="border border-black"></td>
                ...
                <tr>
                  ...
                  <td class="border border-black">₹ 94.34</td>
                  <td class="border border-black">₹ 0</td>
                  <td class="border border-black">₹ 2.38</td>
                  <td class="border border-black">₹ 2.38</td>
                  <td class="border border-black">₹ 0</td>
          ...
          <tr>
            ...
            <td class="border border-black">Farm</td>
            <td class="border border-black">1</td>
            <td class="border border-black">12 Mar 24</td>
            <td class="border border-black"> ₹ 500</td>
            <td class="border border-black">3%</td>
            <td class="border border-black"> 0%</td>
            <td class="border border-black">₹ 485.44</td>
            <td class="border border-black">₹ 14.56</td>
            <td class="border border-black">₹ 0</td>
            <td class="border border-black">₹ 0</td>
            <td class="border border-black">₹ 0</td>
            <td class="border border-black">₹ 0</td>
            <td class="border border-black">Andhra Pradesh</td>
          </tr>
        </table>
      </section>
