      ...
      >
        <div className="h-3/4 w-3/4 ">
          <section class="bill ">
            ...
            {Inputs.bookName == "quotation" && (
              <div className="pt-4 text-xl text-red-700 ">quotation Bill</div>
            )}
            {Inputs.bookName == "PurchaseBook" && (
              <div className="pt-4 text-xl text-red-700 ">Purchase Bill</div>
            )}
            {Inputs.bookName == "SalesBook" && (
              <div className="pt-4 text-xl text-red-700 ">sales Bill</div>
            )}
