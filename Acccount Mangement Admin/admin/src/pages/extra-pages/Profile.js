            ...
            {load ? (
                ...
                <>
                    <div className="w-100 d-flex flex-wrap" style={{ height: '430px' }}>
                        ...
                        {/* <div className="col-lg-6 p-2" style={{ height: '100%' }}>
                            <div className="w-100 rounded-2 bg-white p-3 followlist" style={{ height: '100%' }}>
                                <Tabs
                                    variant="fullWidth"
                                    value={value}
                                ...
                                <TabPanel value={value} index={0} dir={theme.direction} style={{ height: 'calc(100% - 46px)' }}>
                                    <div className="w-100" style={{ height: '340px', overflow: 'scroll' }}>
                                                        ...
                                                        <div className="d-flex align-items-center">
                                                            <div className="position-relative">
                                                                <div className="profile-img-table me-3">
                                                                    <img
                                                                        src={`${baseUrl.imageBase}/uploads/${data.follower_id.profile_picture}`}
                                                                        alt="profile"
                                                                        width="100%"
                                                                        className="object-fit"
                                                                    />
                                                                </div>
                                                                {data.follower_id.is_verified && (
                                                                    <>
                                                            ...
                                                            <div>
                                                                <p className="m-0">{data.follower_id.user_name}</p>
                                                            </div>
                                                        </div>
                                                        <Link
                                                            to={`/profile/${data.follower_id._id}`}
                                                            onClick={() => {
                                                                breadcrumbManager(
                                                                    data.follower_id.user_name,
                                                                    `/profile/${data.follower_id._id}`
                                                                );
                                                                setload(true);
                                                            }}
                                                        >
                                        ...
                                        <div className="m-auto mt-3">{follower?.length < 1 && <Empty />}</div>
                                    </div>
                                </TabPanel>
                                <TabPanel value={value} index={1} dir={theme.direction}>
                                    <div className="w-100" style={{ height: '340px', overflow: 'scroll' }}>
                                                    ...
                                                    >
                                                        <div className="d-flex align-items-center">
                                                            <div className="position-relative">
                                                                <div className="profile-img-table me-3">
                                                                    <img
                                                                        src={`${baseUrl.imageBase}/uploads/${data.following_id.profile_picture}`}
                                                                        alt="profile"
                                                                        width="100%"
                                                                        className="object-fit"
                                                                    />
                                                                </div>
                                                                {data.following_id.is_verified && (
                                                                    <>
                                                                        <div className="verified-user">
                                                                            <CheckCircleFilled />
                                                                        </div>
                                                            ...
                                                            <div>
                                                                <p className="m-0">{data.following_id.user_name}</p>
                                                            </div>
                                                        </div>
                                                        <Link
                                                            to={`/profile/${data.following_id._id}`}
                                                            onClick={() => {
                                                                breadcrumbManager(
                                                                    data.following_id.user_name,
                                                                    `/profile/${data.following_id._id}`
                                                                );
                                                                setload(true);
                                                            }}
                                                        >
                                        ...
                                        <div className="m-auto mt-3">{following?.length < 1 && <Empty />}</div>
                                    </div>
                                </TabPanel>
                                <TabPanel value={value} index={2} dir={theme.direction}>
                                    <div className="w-100" style={{ height: '340px', overflow: 'scroll' }}>
                                                    ...
                                                    >
                                                        <div className="d-flex align-items-center">
                                                            <div className="position-relative">
                                                                <div className="profile-img-table me-3">
                                                                    <img
                                                                        src={`${baseUrl.imageBase}/uploads/${data.report_by_user_id.profile_picture}`}
                                                                        alt="profile"
                                                                        width="100%"
                                                                        className="object-fit"
                                                                    />
                                                                </div>
                                                                {data.report_by_user_id.is_verified && (
                                                                    <>
                                                                        <div className="verified-user">
                                                                            <CheckCircleFilled />
                                                                        </div>
                                                            ...
                                                            <div>
                                                                <h6 className="m-0" style={{ fontSize: '14px' }}>
                                                                    {data?.report_by_user_id?.user_name}
                                                                </h6>
                                                                <p
                                                                    className="m-0"
                                                                    style={{
                                                        ...
                                                        <Link
                                                            to={`/profile/${data.report_by_user_id._id}`}
                                                            onClick={() => {
                                                                breadcrumbManager(
                                                                    data.report_by_user_id.user_name,
                                                                    `/profile/${data.report_by_user_id._id}`
                                                                );
                                                                setload(true);
                                                            }}
                                                        >
                                        ...
                                        <div className="m-auto mt-3">{report?.length < 1 && <Empty />}</div>
                                    </div>
                                </TabPanel>
                            </div>
                        </div> */}
