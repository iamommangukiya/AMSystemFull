...
const Login = () => {
  ...
  return (
    ...
    <div className="bg-[#f9fbfd] dark:bg-dark text-black min-h-screen relative z-10">
      ...
      <div className="min-h-[calc(100vh-134px)] py-4 px-4 sm:px-12 flex justify-center items-center max-w-[1440px] mx-auto">
        <div className="max-w-[550px] flex-none w-full bg-white border border-black/10 p-6 sm:p-10 lg:px-10 lg:py-14 rounded-2xl loginform dark:bg-darklight dark:border-darkborder">
          ...
          <form className="space-y-4" onSubmit={handlesubmit}>
            ...
            <button
              type="submit"
              className="btn w-full py-3.5 text-bas bg-purple border border-purple rounded-md text-white transition-all duration-300 hover:bg-purple/[0.85] hover:border-purple/[0.85]"
            >
              Sign In
            </button>
          </form>
      ...
      {/* <!-- Start Footer --> */}
      <footer className="py-5 text-center text-black dark:text-white/80 max-w-[1440px] mx-auto">
        <div>
          &copy;
          <script>
